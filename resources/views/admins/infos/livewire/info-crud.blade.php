...
<div class="modal fade" id="crudInfoModal" tabindex="-1" role="dialog" aria-hidden="true" wire:ignore.self>
                ...
                <div class="modal-body" wire:loading.remove wire:target="modalSetup">
                    ...
                    @else
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <label class="crud-label col-1 mx-1 p-0">Phone:</label>
                                <input class="col-10 p-0" type="text" class="form-control crud-input"
...
@push('script')
    <script>
        $(document).ready(function() {
            $('#crudInfoModal').on('show.bs.modal', function(e) {
                var id = e.relatedTarget.getAttribute('data-info-id') ?? 0
                @this.call('modalSetup', id)
            })

            $(document).on('closeCrudInfo', function() {
                $('#crudInfoModal').modal('hide')
            })
        })
    </script>
@endpush
