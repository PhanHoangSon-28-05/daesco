<div class="navbar navbar-expand-lg navbar-dark navbar-static">
    ...
    <div class="navbar-brand text-center text-lg-left">
        <img src="{{ URL::asset('images/inc/logo-dsco.png') }}" class="d-none d-sm-block" alt="">
        <img src="{{ URL::asset('admins/global_assets/images/logo_icon_light.png') }}" class="d-sm-none" alt="">
    </div>
    ...
    <ul class="navbar-nav flex-row order-1 order-lg-2 flex-1 flex-lg-0 justify-content-end align-items-center">
        ...
        <li class="nav-item nav-item-dropdown-lg dropdown dropdown-user h-100">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="{{ route('logout.perform') }}" class="dropdown-item"><i class="icon-switch2"></i>
                    Logout</a>
            </div>
        </li>
    </ul>
